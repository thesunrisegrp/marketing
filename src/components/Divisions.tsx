    ...
    <section id="divisions" className="py-24 bg-neutral-50 border-t border-neutral-200">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          {/* Image Side */}
          {/* Image Side - Placeholder until professional photos */}
          <div className="lg:col-span-5 relative h-[500px] lg:h-auto overflow-hidden group reveal bg-neutral-200 flex items-center justify-center">
